...
function Library:HideUI()
    for _, object in pairs(self.ThemeObjects.Main) do
        object.Visible = false
    end
    for _, object in pairs(self.ThemeObjects.Secondary) do
        object.Visible = false
    end
    for _, object in pairs(self.ThemeObjects.Tertiary) do
        object.Visible = false
    end
    for _, object in pairs(self.ThemeObjects.StrongText) do
        object.Visible = false
    end
    for _, object in pairs(self.ThemeObjects.WeakText) do
        object.Visible = false
    end
end
